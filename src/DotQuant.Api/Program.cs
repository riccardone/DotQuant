...
public class Program
{
    ...
    private static WebApplicationBuilder ConfigureServices(WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddSingleton<IAiHedgeFundProvider, FakeAiHedgeFundProvider>();
        builder.Services.AddSingleton<TradingInitializer>();
        builder.Services.AddSingleton<AiHedgeFund.Contracts.IDataReader, FakeAiDataReader>();
